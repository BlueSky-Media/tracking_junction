          ...
          <table className="w-full" style={{ fontSize: "11px" }}>
            ...
            <tbody>
              {[
                ...
                { field: "funnel_id", type: "string", req: false, when: "Every event", desc: "Unique funnel identifier for separating analytics per landing page variant (e.g., \"lead-seniors-f3q8\")" },
